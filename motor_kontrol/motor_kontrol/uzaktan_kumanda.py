    ...
    def read_serial(self):
        if self.ser.in_waiting > 0:
            ...
            try:
                ...
                mode = numbers[5]      
                kp = (numbers[6]-1000)/1000
                kd = (numbers[7]-1000)/1000
                
                if(numbers[3] > 1990):
                    self.ki = self.ki + 0.01
                ...
                if (self.mode == 1):
                    ...
                    self.stm_sag_on.write(solhiz.encode('utf-8'))
